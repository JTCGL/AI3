...
- Keep `check-docs.sh` portable across the supported Bash environments and limited to deterministic mechanical
  validation. Do not encode subjective architectural or roadmap judgments as brittle text-presence rules.
