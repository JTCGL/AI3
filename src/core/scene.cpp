...
ObjectId Scene::create_object(CreateObject object)
{
...
ObjectId Scene::create_named_object(std::string localized_base_name, CreateObject object,
                                    SubtypeKey subtype)
{
...
ObjectId Scene::create_sphere(std::string localized_base_name, SpherePrimitive sphere)
{
    CreateObject object{""};
...
ObjectId Scene::create_box(std::string localized_base_name, BoxPrimitive box)
{
    CreateObject object{""};
    object.category = ObjectCategory::primitive;
...
ObjectId Scene::create_perspective_camera(std::string localized_base_name, PerspectiveCamera camera)
{
    CreateObject object{""};
...
ObjectId Scene::create_directional_light(std::string localized_base_name, DirectionalLight light)
{
    CreateObject object{""};
...
bool Scene::set_sphere(ObjectId id, SpherePrimitive sphere)
{
...
bool Scene::set_box(ObjectId id, BoxPrimitive box)
{
    SceneObject* object = find_object_mutable(id);
...
void Scene::rebuild_bounds(SceneObject& object)
{
    object.bounds = {};
    if (object.primitive_kind == PrimitiveKind::sphere)
    {
...
MaterialId Scene::create_material(std::string localized_base_name, Material material)
{
...
bool Scene::rename_material(MaterialId id, std::string name)
{
...
bool Scene::set_material(MaterialId id, Material material)
{
...
bool Scene::assign_material(ObjectId id, MaterialId material_id)
{
    SceneObject* object = find_object_mutable(id);
    if (object == nullptr ||
        (object->primitive_kind != PrimitiveKind::sphere &&
...
bool Scene::set_sphere_fallback_color(ObjectId id, glm::vec3 linear_color)
{
    SceneObject* object = find_object_mutable(id);
    if (object == nullptr || object->primitive_kind != PrimitiveKind::sphere ||
...
bool Scene::set_perspective_camera(ObjectId id, PerspectiveCamera camera)
{
    SceneObject* object = find_object_mutable(id);
...
bool Scene::set_directional_light(ObjectId id, DirectionalLight light)
{
    SceneObject* object = find_object_mutable(id);
...
bool Scene::rename_object(ObjectId id, std::string name)
{
    SceneObject* object = find_object_mutable(id);
    if (object == nullptr)
        return false;
...
bool Scene::set_object_enabled(ObjectId id, bool enabled)
{
    SceneObject* object = find_object_mutable(id);
    if (object == nullptr)
        return false;
...
bool Scene::set_object_visible(ObjectId id, bool visible)
{
    SceneObject* object = find_object_mutable(id);
    if (object == nullptr)
        return false;
...
bool Scene::set_local_transform(ObjectId id, Transform transform)
{
    SceneObject* object = find_object_mutable(id);
...
bool Scene::set_world_position(ObjectId id, glm::vec3 world_position)
{
    SceneObject* object = find_object_mutable(id);
...
bool Scene::reparent_object(ObjectId id, ObjectId new_parent)
{
    SceneObject* object = find_object_mutable(id);
...
bool Scene::delete_object(ObjectId id)
{
...
Material* Scene::find_material_mutable(MaterialId id)
{
...
const Material* Scene::find_material(MaterialId id) const
{
...
SceneObject* Scene::find_object_mutable(ObjectId id)
{
...
const SceneObject* Scene::find_object(ObjectId id) const
{
...
std::vector<ObjectId> Scene::children_of(ObjectId parent) const
{
...
ResolvedTransform Scene::world_transform(ObjectId id) const
{
...
glm::mat4 Scene::world_transform_matrix(ObjectId id) const { return world_transform(id).matrix; }

glm::vec3 Scene::world_position(ObjectId id) const { return world_transform(id).position; }

glm::quat Scene::world_orientation(ObjectId id) const { return world_transform(id).orientation; }

std::vector<const SceneObject*> Scene::objects_by_category(ObjectCategory category,
...
std::vector<const SceneObject*> Scene::primitives(PrimitiveKind kind,
                                                  ObjectQueryFilter filter) const
{
    std::vector<const SceneObject*> matches;
...
std::vector<const SceneObject*> Scene::cameras(CameraKind kind, ObjectQueryFilter filter) const
{
    std::vector<const SceneObject*> matches;
...
std::vector<const SceneObject*> Scene::lights(LightKind kind, ObjectQueryFilter filter) const
{
    std::vector<const SceneObject*> matches;
...
void Scene::advance_document_revision()
{
