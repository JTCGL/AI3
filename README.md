...
The application's single viewport has display-independent view state outside Dear ImGui. Its localized View
selector can use the preserved Orbit view or a Perspective Camera scene object. Scene-camera matrices are
derived from current authoritative world transforms and projection parameters, while the GLES3 renderer
